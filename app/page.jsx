...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/homepage')
      ...
      .then(d => {
        ...
        setNewsByCategory(d.newsByCategory || {});
        setFeatured(d.featured || null);
        setTrendingList(d.trending || []);
      })
      .catch(() => {})
  ...
  function CategorySection({ section, sectionIndex }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <TrendingNews items={trendingList} />
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="lg:col-span-9 space-y-12">
              {categorySections.map((section, index) => (
                <CategorySection key={section.category._id} section={section} sectionIndex={index} />
              ))}

              {loaded && categorySections.length === 0 && (
